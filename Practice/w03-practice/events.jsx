...
function newTask() {
  ...
  // add it to our arrays tasks. In this way the task input is still pushed as the details
...
function removeTask(taskElement) {
  ...
  tasks = tasks.filter(
    (task) => task.detail != taskElement.childNodes[0].innerText// there are methods that are actually there to do whatever. Just research.
  );
...
/*Add event listener and add input to array */
