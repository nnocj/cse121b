// loops.js
myInfo = { // this reminds me of odeen internship json file.
    name: "Brother T",
  ...
  // this code uses loop foreach to replace all the chunk of code.
  var favFood = myInfo.favoriteFoods
  favFood.foreach(function(food)
  {
    let favoriteFood = document.createElement("li");
    favoriteFood.textContent = myInfo.favoriteFoods[food];
  ...
  var favFood = myInfo.favoriteFoods
  favFood.map(function createAppendFood(food)
  {
    let favoriteFood = document.createElement("li");
    favoriteFood.textContent = myInfo.favoriteFoods[food];
...
// requires an place string. I somewahat understand these let's see what i can do with them.
// returns that string embedded in HTML markup
